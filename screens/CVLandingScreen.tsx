          ...
          >
            {isProcessing ? (
              <div className="flex flex-col items-center animate-pulse">
                <span className="material-symbols-outlined text-4xl lg:text-5xl text-primary mb-3 lg:mb-4 animate-spin">progress_activity</span>
              ...
              <>
                <div className="size-16 lg:size-20 rounded-full bg-white/5 flex items-center justify-center group-hover:bg-primary/20 transition-colors">
                  <span className="material-symbols-outlined text-3xl lg:text-4xl text-gray-400 group-hover:text-primary">upload_file</span>
                </div>
                <div>
