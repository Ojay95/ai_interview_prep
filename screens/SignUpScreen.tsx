    ...
    <div className="flex min-h-screen w-full bg-background-dark">
      <div className="flex-1 flex flex-col justify-center px-6 py-12 lg:px-20 xl:px-24 overflow-y-auto">
        ...
        <div className="w-full max-w-[440px] mx-auto mt-16 lg:mt-0">
          <div className="mb-8">
            <h1 className="text-3xl md:text-4xl font-bold tracking-tight text-white mb-3">Get started for free</h1>
            <p className="text-text-secondary text-base">Create an account to access 1 free mock interview per day. No credit card required.</p>
          </div>

          <div className="grid grid-cols-2 gap-4 mb-8">
            <button className="flex items-center justify-center gap-2 rounded-xl border border-border-dark bg-surface-dark py-2.5 px-4 text-sm font-medium text-white hover:bg-[#252833] transition-colors">
          ...
          <div className="relative mb-8">
            ...
            <div className="relative flex justify-center text-xs uppercase text-text-secondary">
              <span className="bg-background-dark px-2">Or sign up with email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              ...
              <input 
                className="w-full rounded-xl border border-border-dark bg-surface-dark h-12 px-4 text-base text-white placeholder-text-secondary focus:border-primary focus:ring-1 focus:ring-primary transition-all" 
                id="email" 
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <input 
                  ...
                  required
                />
                <button className="absolute right-4 top-1/2 -translate-y-1/2 text-text-secondary hover:text-white" type="button">
      ...
      <div className="hidden lg:flex lg:flex-1 relative bg-surface-dark overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-[#111827]/90 via-[#1e1b4b]/80 to-[#111827]/90"></div>
