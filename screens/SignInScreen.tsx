  ...
  return (
    <div className="flex min-h-screen w-full bg-background-dark">
          ...
          <div className="w-full max-w-[420px] self-center">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center gap-2">
                <input type="checkbox" id="remember" className="rounded border-border-dark bg-surface-dark text-primary focus:ring-primary" />
      ...
      <div className="hidden lg:flex lg:flex-1 relative bg-surface-dark overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-primary/20 via-background-dark/90 to-background-dark"></div>
          ...
          <div className="mb-10 max-w-lg">
            ...
            <div className="flex items-center gap-4">
               ...
               <div>
                  ...
                  <p className="text-text-secondary text-sm">Software Engineer @ Stripe</p>
               </div>
            </div>
          </div>
        </div>
